                ...
                <div class="items items-header-section">
                    <div class="item-content">
                        ...
                        <div class="user-phone">
                            <h4 style="margin-left: 3px;">ID</h4>
                        </div>
                            ...
                            <div class="item-content">
                                <div class="user-profile">
                                    ...
                                    <div class="user-meta-info">
                                        <p class="user-name" data-name="Alan Green">{{ $each->project_name }}</p>
                                    </div>
                                </div>
                                <div class="user-email">
                                    <p class="usr-email-addr" data-email="alan@mail.com">{{ $each->project_key }}</p>
                                </div>
                                <div class="user-location">
                                    <p class="info-title">Location: </p>
                                    <p class="usr-location" data-location="Boston, USA">{{ $each->project_type }}</p>
                                </div>
                                <div class="user-phone">
                                    <p class="info-title">Phone: </p>
                                    <p class="usr-ph-no" data-phone="+1 (070) 123-4567">{{ $each->project_id }}</p>
                                </div>
                                <div class="action-btn">
